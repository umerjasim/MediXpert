...
async function updateIndexes() {
    ...
    for (const collectionKey of Object.keys(constants_1.collectionNames)) {
        const collectionName = constants_1.collectionNames[collectionKey];
        console.log(`Updating indexes for collection: ${collectionName}`);
        const collection = db.collection(collectionName);
        const objectIdFields = getObjectIdFieldsForCollection(collectionKey);
...
function getObjectIdFieldsForCollection(collectionKey) {
    const objectIdFieldsMap = {
