...
const isLocalhost = Boolean(
  ...
  function configOnUpdate(config: any, registration: any) {
    if (config && config.onUpdate) {
      config.onUpdate(registration);
    }
  }
  function configOnSuccess(config: any, registration: any) {
          ...
          installingWorker.onstatechange = () => {
            if (installingWorker.state === 'installed') {
              if (navigator.serviceWorker.controller) {
                ...
                // Execute callback
                return configOnUpdate(config, registration);
              } else {
                ...
                // Execute callback
                return configOnSuccess(config, registration);
              }
            }
          };
        };
